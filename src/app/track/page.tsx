        ...
        <div className="min-h-screen bg-[#0A0B14] text-white selection:bg-[#CE0003]/30 overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 py-12 relative z-10 flex flex-col min-h-screen">
                <header className="flex justify-between items-center mb-20">
                    ...
                    <Link href="/">
                        <Button variant="ghost" className="text-white/40 hover:text-white hover:bg-white/5 font-light tracking-widest text-[10px] uppercase">
                            Home Portal
                        </Button>
                    </Link>
                </header>
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            >
                                ...
                                <span className="text-[10px] uppercase tracking-[0.3em] text-white/40 font-medium">Secure Tracing</span>
                            </motion.div>
                        ...
                        <Card className="bg-white/[0.03] backdrop-blur-2xl border-white/10 shadow-2xl rounded-[2.5rem] overflow-hidden">
                                    ...
                                    <div className="space-y-3 text-left">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                className="bg-white/5 border-white/10 h-16 pl-12 rounded-[1.25rem] focus:border-[#CE0003] focus:ring-1 focus:ring-[#CE0003]/20 placeholder:text-white/5 text-lg font-light tracking-widest uppercase transition-all"
                                                required
                                            />
                                        </div>
                                    </div>
                        ...
                        <div className="pt-12">
                            <p className="text-[10px] text-white/20 font-light tracking-[0.4em] uppercase">
                ...
                <footer className="mt-auto py-8 text-center opacity-20 text-[10px] uppercase tracking-[0.3em] font-light">
