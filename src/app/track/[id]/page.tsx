...
export default function TrackingDetailsPage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-[#0A0B14] text-white selection:bg-[#3B82F6]/30 overflow-x-hidden">
                ...
                <Card className="bg-white/5 border border-white/20 rounded-[2.5rem] mb-16 shadow-2xl overflow-hidden">
                    <CardContent className="p-0">
                        ...
                        <div className="p-8 sm:p-12 grid grid-cols-1 sm:grid-cols-2 gap-12 text-center sm:text-left">
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] uppercase tracking-[0.2em] text-[#3B82F6] font-bold block">Contact Channel</Label>
                                    ...
                                    <div className="p-4 border-t border-white/10 text-white">
                                        ...
                                        <div className="flex gap-3">
                                            <Textarea
                                                ...
                                                className="flex-1 min-h-[44px] max-h-[100px] bg-white/10 border-white/20 rounded-2xl text-sm font-light text-white placeholder:text-white/30 resize-none focus:border-[#3B82F6]/50 focus:ring-1 focus:ring-[#3B82F6]/20"
                                                rows={1}
                                                onKeyDown={(e) => {
                                            ...
                                            <Button
                                                ...
                                                className="h-11 px-4 rounded-xl bg-[#3B82F6] hover:bg-[#3B82F6]/80 text-white font-semibold text-xs border-none shrink-0 transition-all active:scale-95 flex items-center gap-2"
                                            >
                                                {isSending ? (
