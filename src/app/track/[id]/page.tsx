            ...
            {loading ? (
                ...
                <>
                    ...
                    <main className="container mx-auto px-4 sm:px-6 pt-24 pb-32 max-w-3xl relative z-10">
                        ...
                        {/* Delivery Destination & Map Directions for Logistics */}
                        {order.businessType === "logistics" && order.measurements && (
                            <motion.div
                                initial={{ opacity: 0, y: 15 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                className="mb-16 rounded-[2rem] bg-white/[0.03] backdrop-blur-xl border border-white/10 p-6 sm:p-8 space-y-6 shadow-2xl overflow-hidden"
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <Label className="text-[10px] uppercase tracking-[0.25em] text-blue-400 font-bold block">
                                    ...
                                    {/* Action Buttons: Turn-by-Turn GPS Navigation & Call */}
                                    <div className="flex items-center flex-wrap gap-2.5">
                                        <a
                                            href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(order.measurements)}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold shadow-lg shadow-blue-500/20 transition-all hover:scale-105 active:scale-95"
                                        >
                                        ...
                                        {order.customerPhone && (
                                            <a
                                                ...
                                                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/15 text-white text-xs font-bold border border-white/10 transition-all"
                                ...
                                <div className="w-full h-64 sm:h-80 rounded-2xl overflow-hidden border border-white/10 bg-black/40 shadow-inner relative group">
                                    <iframe
                                        ...
                                        loading="lazy"
                                        allowFullScreen
                                        src={`https://maps.google.com/maps?q=${encodeURIComponent(order.measurements)}&t=&z=14&ie=UTF8&iwloc=&output=embed`}
                                        className="w-full h-full border-0 filter contrast-125 saturate-75 opacity-90 group-hover:opacity-100 transition-opacity"
                                    />
                                    <div className="absolute bottom-3 right-3 pointer-events-none">
                                        <div className="px-3 py-1.5 rounded-lg bg-black/80 backdrop-blur-md border border-white/10 text-[10px] font-bold text-white/80 flex items-center gap-1.5 shadow-lg">
