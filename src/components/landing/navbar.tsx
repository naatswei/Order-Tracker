...
export function LandingNavbar() {
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between bg-white/80 backdrop-blur-2xl border border-white/30 shadow-2xl shadow-indigo-500/10 rounded-xl sm:rounded-2xl px-2.5 sm:px-6 py-2 sm:py-3 box-border gap-1 sm:gap-4">
                ...
                {!userId && (
                    <Link href="/sign-in" className="text-[11px] sm:text-sm font-semibold text-slate-600 hover:text-[#191A43] transition-colors whitespace-nowrap px-1">
                        Sign In
                    </Link>
                )}
