                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    {userId ? (
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            <Link href="/sign-in" className="text-xs sm:text-sm font-semibold text-slate-600 hover:text-[#191A43] transition-colors whitespace-nowrap">
                                Sign In
                            </Link>
                            <Link href="/sign-up">
                                <Button className="bg-[#CE0003] hover:bg-[#CE0003]/90 text-white rounded-xl px-3 sm:px-6 h-8 sm:h-11 text-[11px] sm:text-sm font-semibold shadow-md transition-all active:scale-95">
                                    Get Started
                                </Button>
                            </Link>
                        </div>
