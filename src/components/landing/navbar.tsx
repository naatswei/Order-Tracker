...
export function LandingNavbar() {
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between bg-white/80 backdrop-blur-2xl border border-white/30 shadow-2xl shadow-indigo-500/10 rounded-xl sm:rounded-2xl px-3 sm:px-6 py-2 sm:py-3 box-border gap-2">
                ...
                <div className="flex items-center gap-1.5 sm:gap-4">
                    {userId ? (
                        ...
                        <>
                            ...
                            <Link href="/sign-up">
                                <Button className="bg-[#CE0003] hover:bg-[#CE0003]/90 text-white rounded-xl px-3 sm:px-6 h-9 sm:h-11 text-xs sm:text-sm font-semibold shadow-md transition-all active:scale-95">
                                    Get Started
                                </Button>
                            </Link>
                        </>
